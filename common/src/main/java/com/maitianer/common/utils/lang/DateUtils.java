package com.maitianer.common.utils.lang;
...
//	}
     ...
     * @return
     */
    public static String getTimeBeforeMinute(int minute) {
     ...
     * @return
     */
    public static Object[] getMonthArr() {
        Object[] arr = {"01月", "02月", "03月", "04月", "05月", "06月", "07月", "08月", "09月", "10月", "11月", "12月"};
        return arr;
    }
